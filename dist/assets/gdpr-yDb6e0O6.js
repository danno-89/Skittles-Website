import"./modulepreload-polyfill-B5Qt9EMX.js";import"./firebase.config-IpTQKhZm.js";import"./main-CA5my9sR.js";import"https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js";function i(){const a=`
    ...
    `,o=document.getElementById("gdpr-content");o&&(o.innerHTML=a);const t=document.getElementById("privacy-content");t&&(t.innerHTML=e)}function r(a){const e=a.target,o=e.dataset.tab;document.querySelectorAll(".main-tabs .tab-link").forEach(t=>t.classList.remove("active")),e.classList.add("active"),document.querySelectorAll(".tab-pane").forEach(t=>t.classList.remove("active")),document.getElementById(o+"-content").classList.add("active")}document.addEventListener("DOMContentLoaded",a=>{i(),document.querySelectorAll(".main-tabs .tab-link").forEach(e=>e.addEventListener("click",r))});
