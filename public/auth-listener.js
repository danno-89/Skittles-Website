...
import { auth } from './login.js'; // Corrected import path
...
document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        if (!auth) {
            console.error("Firebase auth object is not available in auth-listener.js");
            return;
        }
        ...
        console.error("Error in auth-listener.js:", error);
    }
});
